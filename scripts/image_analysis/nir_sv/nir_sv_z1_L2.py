...
# Pipeline designed for use with Setaria plants at zoom X1 (pot raise level seen in images 2.11.14 - 2.15.14)
...
def main():
    ...
    device, box1_img, rect_contour1, hierarchy1 = pcv.rectangle_mask(img, (1,230), (318,252), device, args.debug)
    ...
    device, roi_img, roi_contour, roi_hierarchy = pcv.rectangle_mask(img, (120,75), (200,230), device, args.debug)
