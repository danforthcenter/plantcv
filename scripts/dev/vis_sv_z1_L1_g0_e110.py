...
def main():
  ...
  device, s_thresh = pcv.binary_threshold(s, 34, 255, 'light', device, args.debug)
  ...
  device, maskeda_thresh2 = pcv.binary_threshold(masked_a2, 110, 255, 'dark', device, args.debug)
