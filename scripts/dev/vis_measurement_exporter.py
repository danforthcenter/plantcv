...
def main():
  ...
  for snapshot in snapshots:
    ...
    if sv_image_count == 2 and tv_area > 0:
      if (args.debug):
      ...
      out.write(','.join(map(str, (plant_id, snapshot, sv_zoom, tv_zoom, sv0_area, sv90_area, tv_area, solidity, perimeter, centroid_x, centroid_y, longest_axis,
