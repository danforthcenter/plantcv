...
def main():
  ...
  device, ab1 = pcv.logical_and(maskeda_thresh1, maskedb_thresh1, device, args.debug)
  ...
  device, ab2 = pcv.logical_and(maskeda_thresh2, maskedb_thresh2, device, args.debug)
  ...
  device, kept_mask4 = pcv.fill(kept_mask4_1, kept_cnt, 12, device, args.debug)
...
############## Analysis ################  
  ...
  device, boundary_header,boundary_data, boundary_img1= pcv.analyze_bound(img, args.image,obj, mask, 920, device,args.debug,args.outdir+'/'+filename)
