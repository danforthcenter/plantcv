...
# Pipeline designed for use with Setaria plants at zoom X1000
...
def main():
    ...
    device, box1_img, rect_contour1, hierarchy1 = pcv.rectangle_mask(img, (1,243), (318,252), device, args.debug)
    ...
    device, roi_img, roi_contour, roi_hierarchy = pcv.rectangle_mask(img, (120,75), (200,243), device, args.debug)
