...
def main():
    ...
    # Header
    # out.write(','.join(map(str, ('plant_id', 'datetime', 'sv_zoom', 'tv_zoom', 'sv0_area', 'sv90_area',
    # 'sv180_area', 'sv270_area', 'tv_area', 'solidity', 'perimeter', 'centroid_x', 'centroid_y',
    out.write(','.join(map(str, (
        'plant_id', 'datetime', 'sv_zoom', 'tv_zoom', 'sv0_area', 'sv90_area', 'tv_area', 'solidity', 'perimeter',
    ...
    for snapshot in snapshots:
        ...
        if sv_image_count == 4 and tv_area > 0:
            ...
            out.write(','.join(map(str, (
                plant_id, snapshot, sv_zoom, tv_zoom, sv0_area, sv90_area, sv180_area, sv270_area, tv_area, solidity,
                perimeter, centroid_x, centroid_y, longest_axis,
            ...
            if args.debug:
                print('Something is wrong, snapshot ' + str(snapshot) + ' has ' + str(
                        sv_image_count) + ' SV images and TV area is ' + str(tv_area))
