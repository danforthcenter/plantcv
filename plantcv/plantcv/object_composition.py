...
def object_composition(img, objects):
    ...
    objects   = List of plantcv Objects class instances
    ...
    :param objects: plantcv.plantcv.classes.Objects
    :return group: plantcv.plantcv.classes.Objects
    ...
    if len(ids) > 0:
        ...
        cv2.drawContours(mask, objects.contours, -1, 255, -1, hierarchy=hierarchy)
