...
def x_axis_pseudolandmarks(img, obj, mask, label=None):
    ...
    outputs.add_observation(variable=prefix + 'bottom_lmk', trait='bottom landmark coordinates',
                            method='plantcv.plantcv.x_axis_pseudolandmarks', scale='none', datatype=tuple,
                            value=tuple(bottom_list), label='none')
    outputs.add_observation(variable=prefix + 'center_v_lmk', trait='center vertical landmark coordinates',
                            method='plantcv.plantcv.x_axis_pseudolandmarks', scale='none', datatype=tuple,
