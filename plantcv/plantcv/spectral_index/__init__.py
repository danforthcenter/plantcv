...
from plantcv.plantcv.spectral_index.spectral_index import npci
...
__all__ = ["ndvi", "gdvi", "savi", "pri", "ari", "ci_rededge", "cri550", "cri700", "egi", "evi", "gli", "sci", "bgr", "bgi",
           "mari", "mcari", "mtci", "ndre", "npci", "psnd_chla", "psnd_chlb", "psnd_car", "psri", "pssr_chla", "pssr_chlb",
           "pssr_car", "rgri", "rvsi", "sipi", "sr", "vari", "vi_green", "wi", "ndci"]
