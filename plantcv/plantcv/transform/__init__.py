...
from plantcv.plantcv.transform.color_correction import plot_correction_comparison
...
__all__= ["get_color_matrix", "get_matrix_m", "calc_transformation_matrix", "apply_transformation_matrix", "plot_correction_comparison", "save_matrix", "load_matrix", "correct_color"]