...
class Click:
    def __init__(self, img, label="default", bin_img=None, bin_img_recover=None, figsize=(12, 6)):
        ...
        self.bin_img_recover = None # binary image with all potential objects (binary image to recover objects) necesssary for the .correct method
        self.bin_img_current = None # current binary mask, updated by _recover_circ 
        self.points = {}
        self.colors = {}
    ...
    def import_coords(self, coords, label="total"):
        ...
        _view(self, label=label, color="c", view_all=True)
    ...
    ### Keep at bottom for now for import order 
