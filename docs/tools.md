...
Tabulate pixel RGB values into a table for naive Bayes training with the command `plantcv-utils tabulate_bayes_classes -i <INFILE> -o <OUTFILE>` 
...
plantcv-utils tabulate_bayes_classes -i unformatted.csv -o bayes_classes_tabulated.csv
```
