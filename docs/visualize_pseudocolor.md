...
- **Parameters:**
    ...
    - bg_image       - Grayscale or RGB image data (optional). Will be used as background if background is set to "image"
...
pseudo_img_on_rgb = pcv.visualize.pseudocolor(gray_img=img, mask=mask,
                                                background="image", bg_image=rgb_img
                                                cmap="viridis")
...
![Screenshot](img/documentation_images/pseudocolor/pseudo_on_rgb_image.jpg)
