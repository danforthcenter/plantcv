...
**plantcv.analyze_bound_horizontal**(*img, obj, mask, line_position, filename=False*)
...
# Set Boundary Line    
boundary_header, boundary_data, boundary_img1 = pcv.analyze_bound_horizontal(img, obj, mask, 950, 'setaria_boundary_img.png')
```
