...
- **Parameters**
    ...
    - color_chip_size  - [Type of color card](transform_detect_color_card.md#supported-color-cards) to be detected, (case insensitive, either "classic", "passport", "nano", "mini",
