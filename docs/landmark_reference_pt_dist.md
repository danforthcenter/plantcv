...
**plantcv.landmark_reference_pt_dist**(*points_r, centroid_r, bline_r, label=None*)
...
pcv.landmark_reference_pt_dist(points_r=points_r, centroid_r=centroid_r, bline_r=bline_r, label=None)
