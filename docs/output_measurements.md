...
| max_temp                      | maximum temperature                               | [analyze_thermal_values](analyze_thermal_values.md)                | degrees C | float     | maximum temperature from input thermal values                                                                                                           |
| min_temp                      | minimum temperature                               | [analyze_thermal_values](analyze_thermal_values.md)                | degrees C | float     | minimum temperature from input thermal values                                                                                                           |
| average_temp                  | mean temperature                                  | [analyze_thermal_values](analyze_thermal_values.md)                | degrees C | float     | mean temperature from input thermal values                                                                                                              |
| median_temp                   | median temperature                                | [analyze_thermal_values](analyze_thermal_values.md)                | degrees C | float     | mediam ([NCIT:C28007](http://purl.obolibrary.org/obo/NCIT_C28007)) temperature from input thermal values                                                |
| thermal_frequencies           | thermal frequencies                               | [analyze_thermal_values](analyze_thermal_values.md)                | degrees C | list      | thermal frequency distribution                                                                                                                          |
| fvfm_hist                     | Fv/Fm frequencies                                 | [fluor_fvfm](fluor_fvfm.md)                                        | none      | list      | [Fv/Fm](https://en.wikipedia.org/wiki/Plant_stress_measurement#Fv/Fm) frequency distribution                                                            |
| fvfm_hist_peak                | peak Fv/Fm value                                  | [fluor_fvfm](fluor_fvfm.md)                                        | none      | float     | peak [Fv/Fm](https://en.wikipedia.org/wiki/Plant_stress_measurement#Fv/Fm) value                                                                        |
| fvfm_median                   | Fv/Fm median                                      | [fluor_fvfm](fluor_fvfm.md)                                        | none      | float     | median ([NCIT:C28007](http://purl.obolibrary.org/obo/NCIT_C28007)) [Fv/Fm](https://en.wikipedia.org/wiki/Plant_stress_measurement#Fv/Fm) value          |
| fdark_passed_qc               | Fdark passed QC                                   | [fluor_fvfm](fluor_fvfm.md)                                        | none      | bool      | true of false (false if the Fdark image has values > 2000)                                                                                              |
