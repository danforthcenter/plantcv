...
| median_temp                   | median temperature                                | [analyze_thermal_values](analyze_thermal_values.md)                | degrees C | float     | median ([NCIT:C28007](http://purl.obolibrary.org/obo/NCIT_C28007)) temperature from input thermal values                                                |
| thermal_frequencies           | thermal frequencies                               | [analyze_thermal_values](analyze_thermal_values.md)                | frequency | list      | thermal frequency distribution                                                                                                                          |
