...
**plantcv.analyze_NIR_intensity**(*img, rgbimg, mask, bins, hisplot=False, filename=False*)
...
hist_header, hist_data, h_norm  = pcv.analyze_NIR_intensity(img, rgbimg, mask, 256, filename="pseudocolored_plant")
```
