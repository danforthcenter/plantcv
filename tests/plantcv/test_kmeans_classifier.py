...
def test_kmeans_classifier(test_data):
    ...
    mask_dict_gray = mask_kmeans(labeled_img=labeled_img_gray, k=4, patch_size=5)
    for i in range(4):
    ...
    combo_mask_gray = mask_kmeans(labeled_img=labeled_img_gray, k=4, patch_size=5, cat_list=[1, 2])
