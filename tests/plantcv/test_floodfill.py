...
def test_floodfill(test_data):
    ...
    fill_img = floodfill(bin_img=img,point=(137,31),value=0)
    fill_img = floodfill(bin_img=fill_img,point=(189,214),value=0)
    fill_img = floodfill(bin_img=fill_img,point=(312,361),value=0)
...
def test_floodfill_bad_input(test_data):
    ...
    with pytest.raises(RuntimeError):
        _ = floodfill(bin_img=img, point = (1,1),value=0)
