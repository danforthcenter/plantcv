...
def test_plantcv_morphology_segment_insertion_angle():
    ...
    pcv.print_results(os.path.join(cache_dir, "results.txt"))
    assert pcv.outputs.observations['segment_insertion_angle']['value'] == [50.75442037373474, 56.45078448114704,
                                                                            57.80220388909291, 66.1559145648012,
                                                                            77.57112958360631, 39.245580536881675,
                                                                            84.24558178912076, 84.24558178912076,
                                                                            50.75442037373474, 26.337516798081822,
                                                                            58.46112771993523, 39.245580536881675,
                                                                            28.645972294617223, 35.371548466069214,
                                                                            20.64797104069403, 62.89851538735208]
    pcv.outputs.clear()
