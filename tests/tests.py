...
# ##############################
# Tests for the annotate subpackage
# ##############################
...
def test_plantcv_annotate_img_registration(tmpdir):
    # Create a test tmp directory
    cache_dir = tmpdir.mkdir("sub")
    ...
    for pt in [(0, 0), (1, 0), (0, 3), (4, 4), (3, 2)]:
        ...
        e1.inaxes._subplotspec = matplotlib.gridspec.SubplotSpec(
            matplotlib.gridspec.GridSpec(1, 2, img_registrator.fig), 0)
        ...
        e2.inaxes._subplotspec = matplotlib.gridspec.SubplotSpec(
            matplotlib.gridspec.GridSpec(1, 2, img_registrator.fig), 1)
    ...
    e1_.inaxes._subplotspec = matplotlib.gridspec.SubplotSpec(matplotlib.gridspec.GridSpec(1, 2, img_registrator.fig),
                                                              0)
    ...
    e2_.inaxes._subplotspec = matplotlib.gridspec.SubplotSpec(matplotlib.gridspec.GridSpec(1, 2, img_registrator.fig),
                                                              1)
