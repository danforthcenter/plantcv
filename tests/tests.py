...
def test_plantcv_segment_image_series():
    ...
    # test cache directory
    cache_img_dir = os.path.join(TEST_TMPDIR, 'segment_image_series_images')
    os.mkdir(cache_img_dir)
    cache_mask_dir = os.path.join(TEST_TMPDIR, 'segment_image_series_masks')
